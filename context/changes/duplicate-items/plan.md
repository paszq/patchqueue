...
- [x] 1.1 Migracja z unikalnym indeksem na (asset_id, upper(identifier)) — e4202d0
- [x] 1.2 Test integracyjny odróżniający odmowę przez regułę od braku reguły — e4202d0
- [x] 1.3 Bramki jakości przechodzą po zastosowaniu migracji — e4202d0

#### Manual

- [x] 1.4 Test czerwony przed migracją, zielony po niej — e4202d0

### Phase 2: Tłumaczenie odmowy w warstwie aplikacji

#### Automated

- [x] 2.1 Normalizacja identyfikatora na ścieżce ręcznej — c1455f6
- [x] 2.2 Naruszenie unikalności zamienione na komunikat w języku produktu — c1455f6
- [x] 2.3 Test przeglądowy ścieżki użytkownika — c1455f6
- [x] 2.4 Bramki jakości i testy przeglądowe przechodzą — c1455f6
