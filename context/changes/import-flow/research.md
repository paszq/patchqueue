...
- **Parsowanie jest czyste** — bez bazy, HTTP i zegara — więc 28 testów pokrywa je tabelą
  przypadków zamiast klikaniem. Trzy z nich złapały prawdziwe błędy (commit `4baf650`):
...
- `commit 4baf650` — wprowadzenie warstwy tłumaczącej wraz z opisem trzech błędów złapanych
