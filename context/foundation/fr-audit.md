...
**Data**: 2026-09-02 · **Commit**: `f5915cd` · **Metoda**: każde wymaganie sprawdzone
...
| 004 | Przeglądanie listy zasobów                                                     | ✅      | `assets/index.astro`; od `af1f3f9` także liczba otwartych pozycji                                                                                    |
...
| 015 | Powrót do zamkniętej pozycji i zobaczenie rozstrzygnięcia wraz z uzasadnieniem | ✅      | **domknięte 2026-09-02** commitem `d1869b6`; test „dowód załatania trafia do historii i zostaje tam po przywróceniu"                                 |
