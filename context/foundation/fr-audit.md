...
**Data**: 2026-09-02 · **Commit**: `4f64151` · **Metoda**: każde wymaganie sprawdzone
...
| 004 | Przeglądanie listy zasobów                                                     | ✅      | `assets/index.astro`; od `12beea1` także liczba otwartych pozycji                                                                                    |
...
| 015 | Powrót do zamkniętej pozycji i zobaczenie rozstrzygnięcia wraz z uzasadnieniem | ✅      | **domknięte 2026-09-02** commitem `cd18a0b`; test „dowód załatania trafia do historii i zostaje tam po przywróceniu"                                 |
